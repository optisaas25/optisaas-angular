...
export class SalesControlController {
  ...
  async getBrouillonWithPayments(
    ...
    return this.salesControlService.getBrouillonWithPayments(
      userId,
      centreId,
      startDate,
      endDate,
  ...
  async getBrouillonWithoutPayments(
    ...
    return this.salesControlService.getBrouillonWithoutPayments(
      userId,
      centreId,
      startDate,
      endDate,
  ...
  async getValidInvoices(
    ...
    return this.salesControlService.getValidInvoices(
      userId,
      centreId,
      startDate,
      endDate,
  ...
  async getAvoirs(
    ...
    return this.salesControlService.getAvoirs(
      userId,
      centreId,
      startDate,
      endDate,
