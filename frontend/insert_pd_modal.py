...
with open('src/app/features/client-management/fiches/monture-form/monture-form.component.html', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# PD Modal HTML content
pd_modal = '''
    ...
    <div class="camera-modal" *ngIf="showPDModal" (click)="closePDMeasurement()">
        <div class="modal-content pd-modal" (click)="$event.stopPropagation()">
            <div class="modal-header">
                <h3>Mesure Écart Pupillaire (EP)</h3>
                <button type="button" class="btn-close" (click)="closePDMeasurement()">×</button>
            </div>
                ...
                <div class="canvas-container" *ngIf="pdStep !== 'capture'">
                    ...
                    <div class="instructions-overlay">
                        <p *ngIf="pdStep === 'calibration' && pdMode === 'sticker'">
                            Cliquez sur les <strong>2 coins supérieurs</strong> du sticker 1cm.
                        </p>
                        <p *ngIf="pdStep === 'calibration' && pdMode === 'bridge'">
                            Cliquez sur les <strong>2 extrémités</strong> du pont de la monture.
                        </p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn-primary" *ngIf="pdStep === 'calibration'"
                ...
                <button type="button" class="btn-success" *ngIf="pdStep === 'measurement' && pdValues.total > 0"
                    (click)="applyPDValues()">
                    ✓ Valider Mesures ({{pdValues.total}} mm)
                </button>
            </div>
        </div>
    </div>
...
# Insert PD modal before the last line
new_content = lines[:-1] + [pd_modal + '\n'] + [lines[-1]]

# Write the modified content
with open('src/app/features/client-management/fiches/monture-form/monture-form.component.html', 'w', encoding='utf-8') as f:
    f.writelines(new_content)

print("PD Modal added successfully!")
